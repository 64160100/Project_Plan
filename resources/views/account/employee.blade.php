    ...
    <div class="container">
        ...
        <table class="table table-striped">
            ...
            <tbody class="table-body" id="employee-table-body">
                ...
                <tr class="employee-row">
                    ...
                    <td>
                        <div class="position-info">
                            ...
                            <div>
                                ...
                                @endif
                                @if ($employee->IsGeneralEmployees === 'Y')
                    ...
                    <td>
                        <div class="actions">
                            <a href="{{ route('account.showemployee', $employee->Id_Employee) }}"
        ...
        <div class="page-info">
            <div id="showing-entries">แสดง <span id="showing-start">1</span> ถึง <span id="showing-end">10</span>
                จากทั้งหมด <span id="total-entries">{{ count($employees) }}</span> รายการ</div>
