...
<head>
    ...
    <head>
        ...
        <div class="container">
            <div class="header">
                <a href="{{ route('status.tracking') }}" class="back-btn">
            ...
            <div class="content-box">
                <div class="all-budget">
                    ...
                    @if($project->Count_Steps >= 10)
                    <div class="special-status">
                        <div class="lightbulb {{ $project->Count_Steps >= 10 ? 'active' : '' }}">
                ...
                <div class="content-box-list">
                    ...
                    <div class="project-name-container">
                        ...
                        <input id="projectName" name="Name_Project" value="{{ $project->Name_Project }}"
                            class="form-control" readonly>
                    </div>

                    <!-- Steps 1-5 -->
                    <div class="steps-row">
                        @for($index = 0; $index < 5; $index++) @php $statusClass='status-I' ; if ($project->Count_Steps
                            >
                            $index) {
                            ...
                            <div class="step {{ $statusClass }}">
                                ...
                                @if($index < 4) <div class="step-line {{ $statusClass }}">
                            </div>
                            @endif
                    </div>
                    @endfor
                ...
                <!-- Steps 6-10 -->
                <div class="steps-row">
                    @for($index = 5; $index < 10; $index++) @php $statusClass='status-I' ; if ($project->Count_Steps >
                        $index) {
                        $statusClass = 'status-Y';
                        } elseif ($project->Count_Steps == $index) {
                        $statusClass = 'status-B';
                        ...
                        <div class="step {{ $statusClass }}">
                            <span class="step-number">{{ $index + 1 }}</span>
                            <span class="step-text">{{ $stepTexts[$index] }}</span>
                            @if($index < 9) <div class="step-line {{ $statusClass }}">
                        </div>
                        @endif
                </div>
                @endfor
            ...
            <div class="special-step-container">
                <div class="special-step {{ $project->Count_Steps >= 10 ? 'status-Y' : 'status-P' }}">
                    <div class="lightbulb-large {{ $project->Count_Steps >= 10 ? 'active' : '' }}">
                        <i class='bx bx-bulb'></i>
                    </div>
                    <span class="step-text">{{ $stepTexts[10] ?? 'การดำเนินการล่าช้า' }}</span>
                </div>
            </div>
