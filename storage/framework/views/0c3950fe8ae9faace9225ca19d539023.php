    ...
    <div class="report-container">
        ...
        <div class="section">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="<?php echo e($project->employee->Prefix_Name); ?><?php echo e($project->employee->Firstname); ?> <?php echo e($project->employee->Lastname); ?>" readonly>
            </div>
        </div>
