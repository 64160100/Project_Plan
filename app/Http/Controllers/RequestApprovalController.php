...
class RequestApprovalController extends Controller
{
    public function showAllApprovals(Request $request)
    {
        ...
        $request->session()->put('recordHistories', $recordHistories ?? null);
        $request->session()->put('statusNCount', $statusNCount);
                ...
                if ($status === 'Y') {
                    ...
                    switch ($project->Count_Steps) {
                        case 0:
                            ...
                            break;
                        case 1:
                            $comment = "เห็นชอบการดำเนินโครงการเบื้องต้นโดยผู้อำนวยการ";
                            break;                    
                        default:
            ...
            if ($status === 'Y') {
                switch ($project->Count_Steps) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        $comment = "อนุมัติข้อมูลโครงการและงบประมาณที่กรอกมา";
                        break;
                    case 3:
                        $comment = "ยืนยันความเหมาะสมของงบประมาณโครงการโดยแผนกงบประมาณ";
                        break;
                    case 4:
                        $comment = "เห็นชอบการดำเนินโครงการโดยหัวหน้าฝ่าย";
                        break;
                    case 5:
                        $comment = "อนุมัติการดำเนินโครงการอย่างเป็นทางการโดยผู้อำนวยการ";
                        break;
                    case 6:
                        $comment = "รับทราบความคืบหน้าของโครงการที่อยู่ระหว่างดำเนินการ";
                        break;
                    case 7:
                        $comment = "รับรองผลการดำเนินงานโครงการโดยหัวหน้าฝ่าย";
                        break;
                    case 8:
                        $comment = "รับรองผลการดำเนินโครงการเสร็จสมบูรณ์โดยผู้อำนวยการ";
                        break;
                    case 11:
                        $comment = "อนุมัติแผนการแก้ไขโครงการที่ล่าช้า";
                        break;
                    default:
                        $comment = "เห็นชอบการดำเนินการตามที่เสนอ";
                }
