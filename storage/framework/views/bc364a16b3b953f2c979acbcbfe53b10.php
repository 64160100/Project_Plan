...
<body>
    ...
    <div class="container">
        ...
        <div class="page-info">
            <div id="showing-entries">แสดง <span id="showing-start">1</span> ถึง <span id="showing-end">10</span> จากทั้งหมด <span id="total-entries"><?php echo e(count($employees)); ?></span> รายการ</div>
