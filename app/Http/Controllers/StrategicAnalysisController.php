...
class StrategicAnalysisController extends Controller
{
    ...
    public function addOpportunity(Request $request)
    {
        ...
        try {
            ...
            Log::error('Error adding strategic opportunity: ' . $e->getMessage());
            return redirect()->back()->with('error', 'Failed to add Strategic Opportunity.');
        }
    }
    ...
    public function destroyOpportunity($id)
    {
        try {
            ...
            return redirect()->back()->with('success', 'Strategic Opportunity deleted successfully.');
        } catch (\Exception $e) {
            Log::error('Error deleting strategic opportunity: ' . $e->getMessage());
            return redirect()->back()->with('error', 'Failed to delete Strategic Opportunity.');
        }
    }
}