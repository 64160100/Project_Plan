                                ...
                                <div class="form-group mb-2 dynamic-field">
                                    <div class="input-group">
                                        ...
                                        <div class="editable"
                                            ...
                                            contenteditable="true"
                                            onblur="saveSubProjects(this, '<?php echo e($project->Id_Project); ?>', 'subProjects')" 
                                            onkeypress="checkEnterSubProject(event, this, <?php echo e($project->Id_Project); ?>)">
                                            <?php echo e($subProject->Name_Sub_Project); ?>
                ...
                <div class="content-box">
                    ...
                    <div class="form-group">
                        <div class="editable hidden" style="border: 1px solid #007bff; padding: px; border-radius: 5px;" 
                            ...
                            onblur="saveData(this, '<?php echo e($project->Id_Project); ?>', 'projectType')"
...
unset($__errorArgs, $__bag); ?>" id="employee_id" name="employee_id"
                                onchange="saveData(this, '<?php echo e($project->Id_Project); ?>', 'Employee_Id')">
...
unset($__errorArgs, $__bag); ?>" name="Name_Strategy" id="Name_Strategy" 
                                        onchange="saveData(this, '<?php echo e($project->Id_Project); ?>', 'Name_Strategy')" required>
                                    ...
                                    <?php if($strategies->isNotEmpty()): ?>
                                        ...
                                        <option value="<?php echo e($strategy->Name_Strategy); ?>"
                                            <?php echo e($strategy->Name_Strategy == $project->Name_Strategy ? 'selected' : ''); ?>>
                        ...
                        <?php $__currentLoopData = $sdgs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sdg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="form-group-sdgs">
                                <div class="form-check">
                                    <label class="form-check-label" for="sdg_<?php echo e($sdg->id_SDGs); ?>">
                                    <input 
                                        class="form-check-input editable" 
                                        type="checkbox" 
                                        name="sdgs[]" 
                                        value="<?php echo e($sdg->id_SDGs); ?>" 
                                        id="sdg_<?php echo e($sdg->id_SDGs); ?>" 
                                        onchange="saveData(this, '<?php echo e($project->Id_Project); ?>', 'sdgs')"
                                        <?php if($project->sdgs->contains('id_SDGs', $sdg->id_SDGs)): ?> checked <?php endif; ?>>
                            ...
                            <div class="dropdown-options">
                                <?php $__currentLoopData = $integrationCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="option-item">
                                        <label>
                                            <input type="checkbox"
                                                name="projectHasIntegrationCategories[<?php echo e($category->Id_Integration_Category); ?>][checked]"
                                                onchange="saveIntegrationData(this, <?php echo e($project->id); ?>)"
                                                <?php if($selectedCategory): ?> checked <?php endif; ?>>
                                        ...
                                        <?php if($category->Name_Integration_Category): ?>
                                            <input type="text" class="additional-info"
                                                name="projectHasIntegrationCategories[<?php echo e($category->Id_Integration_Category); ?>][details]"
                                                value="<?php echo e($category->Integration_Details); ?>" 
                                                data-name="<?php echo e($category->Name_Integration_Category); ?>" 
                                                onchange="saveIntegrationData(this, <?php echo e($project->id); ?>)"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="content-box">
                    ...
                    <div id="objectiveDetails">
                        <div class="form-group">
                            <select class="form-select <?php $__errorArgs = ['Objective_Project'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                            ...
                            onchange="saveData(this, '<?php echo e($project->Id_Project); ?>', 'Objective_Project')">
                                ...
                                <option value="<?php echo e($objective->Details_Strategic_Objectives); ?>"
                                    ...
                                    <?php echo e($objective->Details_Strategic_Objectives); ?>
                    ...
                    <div id="locations-container">
                        <div class="location-item">
                                <input type="text" class="form-control small-input editable" name="location[]" placeholder="กรอกสถานที่"
                                    ...
                                    contenteditable="true"
                                    onblur="saveData(this, '<?php echo e($project->Id_Project); ?>', 'Name_Location')"
                                    onkeypress="checkEnter(event, this)">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group editable">
                                    ...
                                    onchange="saveData(this, '<?php echo e($project->Id_Project); ?>', 'First_Time')">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group editable">
                                    ...
                                    onchange="saveData(this, '<?php echo e($project->Id_Project); ?>', 'End_Time')">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="form-check mb-2 d-flex align-items-center">
                                        <input type="checkbox" id="<?php echo e($source->Id_Budget_Source); ?>" name="budget_source"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="category[]" class="form-control">
                                                            ...
                                                            <option value="<?php echo e($subtop->Id_Subtopic_Budget); ?>">
                                                                <?php echo e($subtop->Name_Subtopic_Budget); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                    </div>
                    ...
                    <div id="outputDetails">
                        <div id="outputContainer" class="dynamic-container">
                            <div class="form-group mt-2 d-flex">
                                ...
                                onkeypress="checkEnter(event, this)" 
                                onblur="saveData(this, '<?php echo e($project->Id_Project); ?>', 'Name_Output')" >
                    ...
                    <div id="successIndicatorsDetails">
                        <div class="form-group">
                            <div class="d-flex align-items-center">
                                <select class="form-select <?php $__errorArgs = ['Success_Indicators'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    onchange="saveData(this, '<?php echo e($project->Id_Project); ?>', 'Success_Indicators')" 
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="content-box">
                    ...
                    <div id="valueTargetDetails">
                        <div class="form-group">
                            <div class="d-flex align-items-center">
                                <select class="form-select <?php $__errorArgs = ['Value_Target'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    onchange="saveData(this, '<?php echo e($project->Id_Project); ?>', 'Value_Target')" 
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.addField = function(containerId, fieldName) {
        ...
        <input type="text" class="form-control" name="${fieldName}" placeholder="เพิ่มรายการ"
               onblur="saveData(this, '<?php echo e($project->Id_Project); ?>', '${fieldName}')"
               onkeypress="checkEnter(event, this)">
        <button type="button" class="btn btn-danger btn-sm remove-field">
            <i class='bx bx-trash'></i>
        </button>
...
<script>
        ...
        function saveSubProjects(element, projectId) {
            ...
            fetch('<?php echo e(route('projects.updateSubProject')); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
    ...
    function saveSDGsData(element, projectId) {
        ...
        fetch('<?php echo e(route('projects.updateSDGs')); ?>', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
    ...
    return fetch('<?php echo e(route('projects.updateOutputs')); ?>', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'  
