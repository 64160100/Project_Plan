...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    <option value="<?php echo e($strategy->Name_Strategy); ?>"><?php echo e($strategy->Name_Strategy); ?>
                        ...
                        <div class="dropdown-container">
                            <div class="dropdown-options">
                                ...
                                <div class="option-item">
                                    ...
                                    <?php if($category->Name_Integration_Category !== 'การบริการสารสนเทศ'): ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ============ ตัวชี้วัดความสำเร็จของโครงการ ============
    window.toggleSuccessIndicators = function() {
        const details = document.getElementById('successIndicatorsDetails');
        const icon = document.getElementById('toggleIconSuccessIndicators');
...
<?php echo $__env->make('navbar.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/Project/createProject.blade.php ENDPATH**/ ?>